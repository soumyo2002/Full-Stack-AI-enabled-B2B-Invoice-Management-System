...
const AddDialog = (props) => {
  ...
  const [sl_no, set_sl_no] = useState("");
  const [customer_order_id, set_customer_order_id] = useState("");
  const [sales_org, set_sales_org] = useState("");
  const [distribution_channel, set_distribution_channel] = useState("");
  const [company_code, set_company_code] = useState("");
  const [order_creation_date, set_order_creation_date] = useState(new Date());
  const [order_currency, set_order_currency] = useState("");
  const [customer_number, set_customer_number] = useState("");
  const [amount_in_usd, set_amount_in_usd] = useState("");
  const [order_amount, set_order_amount] = useState("");
  ...
  const handleSubmit = (e) => {
    ...
    const url = `http://localhost:8080/h2h_milestone_3/addInvoice?sl_no=${sl_no}&customer_order_id=${customer_order_id}&sales_org=${sales_org}&distribution_channel=${distribution_channel}&company_code=${company_code}&order_creation_date=${order_creation_date}&order_currency=${order_currency}&customer_number=${customer_number}&amount_in_usd=${amount_in_usd}&order_amount=${order_amount}`;
            ...
            <Grid container spacing={2}>
              <Grid item md={3}>
                <TextField
                  ...
                  label="SL No"
                  size="small"
                  onChange={(e) => set_sl_no(e.target.value)}
                  className={classes.txtBox}
                />
              </Grid>
              <Grid item md={3}>
                <TextField
                  ...
                  size="small"
                  onChange={(e) => set_customer_order_id(e.target.value)}
                  className={classes.txtBox}
                />
              </Grid>
              <Grid item md={3}>
              ...
              <Grid item md={3}>
                <TextField
                  ...
                  size="small"
                  onChange={(e) => set_distribution_channel(e.target.value)}
                  className={classes.txtBox}
                />
              </Grid>
              <Grid item md={3}>
                <TextField
                  ...
                  label="Company Code"
                  size="small"
                  onChange={(e) => set_company_code(e.target.value)}
                  className={classes.txtBox}
                />
              </Grid>
              <Grid item md={3}>
                <TextField
                  ...
                  type="date"
                  defaultValue="2017-05-24"
                  onChange={(e) => set_order_creation_date(e.target.value)}
                  className={classes.txtBox}
                />
              </Grid>
              <Grid item md={3}>
                <TextField
                  ...
                  size="small"
                  onChange={(e) => set_order_currency(e.target.value)}
                  className={classes.txtBox}
                />
              </Grid>
              <Grid item md={3}>
